...
const getTransform = (transforms, type, name, vars) => partialRight(
...
export const query = ({
  ...
  const mapVars = getTransform(graphqlVarTransforms, 'queries', name, vars)
...
export const mutate = ({
  ...
  const mapVars = getTransform(graphqlVarTransforms, 'mutations', name, vars)
